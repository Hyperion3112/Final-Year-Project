        ...
        <main className="">
          <form className="">
            <fieldset className="">
              ...
              <div className="">
                <div className="mt3 br5 ba .di b--black-10  mv4 shadow-5  pa3">
              ...
              <div className="mv3 mt3 br5 ba b--black-10  mv4 shadow-5  pa3 ">
                <label className="db fw6 lh-copy f3" htmlFor="phone">
                  Phone No.
                </label>
                <input
              ...
              <label className="db fw6 lh-copy f3">Domain and preference</label>
              <input
